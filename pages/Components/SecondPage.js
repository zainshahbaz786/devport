...
const SecondPage = () => {
  return (
   ...
   <div className='font-serif text-green-400 text-3xl bg-blue-200 justify-center text-center font-medium'>
    ...
    {/* main div */}
        <div  className='bg-layers flex p-1/5 justify-around w4/5' > 

{/* first div */}
                


<div className="block p-5 w-1/3 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
