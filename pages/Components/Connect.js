...
text-gray-900  rounded-lg border border-green-500 focus:ring-green-700 focus:border-green-500 dark: bg-green-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..."></textarea>
...
<button  type="Submit"  className="text-white bg-green-400 border-black hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-black-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 ">
  ...
  <hr className="my-4 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-2" />
    ...
    <div className="w-1/3  text-sm text-gray-500 sm:text-center md:text-center lg:text-center dark:text-gray-400 hover:text-green-600 hover:underline   ">Develop with 💚 by Zain Shahbaz
        ...
        <div className="flex mt-2 space-x-0   w-1/3 justify-around mb-5">
            <a href="mailto:zainjatt.zj@gmail.com" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
             ...
             <a href="https://www.instagram.com/zain__shahbaz/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://twitter.com/Pure_Banter007" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
            </a>
            <a href="https://github.com/zainshahbaz786" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
